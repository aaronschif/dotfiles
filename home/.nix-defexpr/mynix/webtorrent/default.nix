...
in rec {
  webtorrent-desktop = fetchFromGitHub {
    repo = "webtorrent-desktop";
    owner = "feross";
    rev = "v0.12.0";
    sha256 = "1d3n0j3l0jhv5mhn480xypb3in8ppdy39w1kfsr99l8p6bbwffim";
  };
...
in nodePackages.buildNodePackage {
  ...
  skipOptionalDependencies = ["appdmg" "appdmg==^0.4.3" "appdmg-0.4.5"];
